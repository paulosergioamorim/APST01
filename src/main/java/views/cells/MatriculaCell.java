...
public class MatriculaCell implements ListCellRenderer<Matricula> {
    ...
    private void $$$setupUI$$$() {
        panel = new JPanel();
        panel.setLayout(new FormLayout("center:200px:grow,left:4dlu:noGrow,center:50px:grow,left:4dlu:noGrow," +
                                               "center:50px:noGrow,left:4dlu:noGrow,center:100px:grow," +
                                               "left:4dlu:noGrow,center:50px:grow,left:4dlu:noGrow,center:100px:grow"
                , "center:d:grow"));
