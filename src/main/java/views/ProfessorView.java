...
public class ProfessorView extends JFrame {
    ...
    public ProfessorView(final Control control) {
        super("Professores");
        ...
        this.saveButton.addActionListener(e -> control.saveProfessor());
        this.updateButton.addActionListener(e -> control.updateProfessor());
        this.deleteButton.addActionListener(e -> control.deleteProfessor());
    }
    ...
    public void clearFields() {
        ...
        this.titulacaoField.setText(null);
    }

    public void updateListViewer(final List<Professor> professores) {
        final DefaultListModel<Professor> modelProfessor = new DefaultListModel<>();
        modelProfessor.addAll(professores);
        this.listView.setModel(modelProfessor);
    }
    ...
    private void createUIComponents() {
        ...
        final ProfessorCell cell = new ProfessorCell();
    ...
    public String getTitulacao() { return this.titulacaoField.getText(); }

    public JList<Professor> getListView() { return this.listView; }
