...
public class ProfessorView extends JFrame {
    ...
    public ProfessorView(Control control) {
        ...
        saveButton.addActionListener(e -> this.saveProfessor());
        updateButton.addActionListener(e -> this.updateProfessor());
        deleteButton.addActionListener(e -> this.deleteProfessor());
    }
    ...
    private void saveProfessor() {
        try {
            ...
            control.saveProfessor(cpf, nome, sexo, dataNascimento, titulacao);
        } catch (Exception e) {
            e.printStackTrace();
            control.showMessage("Erro ao salvar professor!");
        }
    }
    ...
    private void updateProfessor() {
        try {
            ...
            e.printStackTrace();
            control.showMessage("Erro ao atualizar professor!");
        }
    }

    private void deleteProfessor() {
        try {
            Professor professor = listView.getSelectedValue();
            long cpf = professor != null ? professor.getCpf() : -1;
            control.deleteProfessor(cpf);
        } catch (Exception e) {
            e.printStackTrace();
            control.showMessage("Erro ao deletar professor");
        }
    }
