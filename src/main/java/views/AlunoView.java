...
public class AlunoView extends JFrame {
    ...
    public AlunoView(Control control) {
        ...
        saveButton.addActionListener(e -> this.saveAluno());
        deleteButton.addActionListener(e -> this.deleteAluno());
        updateButton.addActionListener(e -> this.updateAluno());
    }
    ...
    private void saveAluno() {
        try {
            ...
            e.printStackTrace();
            control.showMessage("Erro ao salvar aluno!");
        }
    }
    ...
    private void updateAluno() {
        try {
            ...
            e.printStackTrace();
            control.showMessage("Erro ao atualizar aluno!");
        }
    }

    private void deleteAluno() {
        try {
            Aluno aluno = listView.getSelectedValue();
            long cpf = aluno != null ? aluno.getCpf() : -1;
            control.deleteAluno(cpf);
        } catch (Exception e) {
            e.printStackTrace();
            control.showMessage("Erro ao deletar aluno!");
        }
    }
