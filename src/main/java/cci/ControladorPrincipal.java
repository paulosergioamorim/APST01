	...
	public int cadastrarCurso(String nome, int ch) {
		...
		switch (response) {
			case 0:
				...
				break;
			case 1:
				JOptionPane.showMessageDialog(janCadCurso, "Preencha os campos para cadastrar o curso");
				break;
			case 2:
				JOptionPane.showMessageDialog(janCadCurso, "Um curso com esse nome já existe");
				break;
		}
		return response;
	}
	...
	public int cadastrarProfessor(String nome, LocalDate dataNascimento, long cpf, String titulacao) {
		...
		switch (response) {
			...
			case 1:
				...
				break;
			case 2:
				JOptionPane.showMessageDialog(janCadProfessor, "A data de nascimento é futura");
				break;
		}
		return response;
	}
	...
	public int cadastrarAluno(String nome, LocalDate dataNascimento, long cpf) {
		...
		switch (response) {
			...
			case 1:
				...
				break;
			case 2:
				JOptionPane.showMessageDialog(janCadAluno, "A data de nascimento é futura");
				break;
		}
		return response;
	}
